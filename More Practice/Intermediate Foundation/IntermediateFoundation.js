...
var x = secondToLast([1,2,3,4,5]);
var y = secondToLast([1,2]);
console.log(x);
console.log(y);
...
var x = nthToLast([1,2],5);
var y = nthToLast([5,2,3,6,4,9,7],3);
console.log(x);
console.log(y);
...
var y = secondLargest([1, 9, 5, 4]);
var x = secondLargest([2, 10, 15, 4]);
console.log(y)
console.log(x)
...
var x = doubleTrouble([4, "Ulysses", 42, false] )
console.log(x);